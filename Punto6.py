...
def menciona_traje_armadura(superheroes):
    resultado = []
    for heroe in superheroes:
...
print(f"Superhéroes que mencionan 'traje' o 'armadura': {menciona_traje_armadura(superheroes)}")
...
def informacion_superheroe(superheroes, nombres):
    resultado = []
    for heroe in superheroes:
...
informacion = informacion_superheroe(superheroes, ["Flash", "Star-Lord"])
for info in informacion:
    print(info)

print("")
print("PUNTO H")
def listar_por_letras(superheroes, letras):
    resultado = []
    for heroe in superheroes:
...
print(f"Superhéroes que comienzan con B, M o S: {listar_por_letras(superheroes, ['B', 'M', 'S'])}")

print("")
print("PUNTO I")
def contar_por_casa(superheroes):
...
print(f"Cantidad de superhéroes por casa: {contar_por_casa(superheroes)}")
